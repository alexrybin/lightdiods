...
*/
    ...
    $categories_arrr = jShopCategoriesHelper::getCatsArray($field_sort, $ordering, $category_id, $categories_id);
    
    $jshopConfig = JSFactory::getConfig();

    require(JModuleHelper::getLayoutPath('mod_jshopping_categories_footer'));
?>