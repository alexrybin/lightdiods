...
<div class="producers-menu--choice">
    <h3 class="head-producers">Производители</h3>

    <div class="j-producers-menu-wrapper">
...
<form action="<?php print $_SERVER['REQUEST_URI'];?>" method="post" name="jshop_filters">
    ...
    <span class="box_manufacrurer">
        ...
        <input class="filter_manufactures" type="checkbox" name="manufacturers[]" value="<?php print $v->id;?>" <?php if (in_array($v->id, $manufacturers)) print "checked";?> onclick="document.jshop_filters.submit();"> <?php print $v->name;?><br/>
        <?php }?>
    </span>
    <br/>
    <?php }?>
