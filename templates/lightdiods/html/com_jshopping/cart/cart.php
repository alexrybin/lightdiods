	...
	<?php $i=1; foreach($this->products as $key_id=>$prod){ ?> 
		<tr class="jshop_prod_cart <?php if ($i%2==0) echo "even"; else echo "odd"?>">
    		...
    		<td class="qty" headers="number">
                ...
                <a class="reload" href="#" onclick="document.updateCart.submit();">Обновить</a>
				<span class = "cart_reload"><img class="reload" style="cursor:pointer" src="<?php print $this->image_path ?>/images/reload.png" title="<?php echo _JSHOP_UPDATE_CART ?>" alt = "<?php echo _JSHOP_UPDATE_CART ?>" onclick="document.updateCart.submit();" /></span>
    		</td>
