<?php
	  $dig_nds = number_format((18*$order->order_total)/118, 2, '.', ''); 
	  $vtch_nds = '<td style="font-size:8.5pt;" width="120">Сумма платы за услуги</td><td width="70"></td><td style="font-size:8.5pt;" width="30">'. $order->currency_code .'</td><td width="70"></td>';
 	  if ($params['nds'])  $vtch_nds = '<td style="font-size:8.5pt;" width="120">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;в&nbsp;т.ч.&nbsp;НДС&nbsp;-&nbsp;</td><td width="70">'.$dig_nds.'</td><td style="font-size:8.5pt;" width="30">'. $order->currency_code .'</td><td width="70"></td>';
