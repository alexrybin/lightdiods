...
<?php if ($this->config->show_sort_product || $this->config->show_count_select_products){?>
    ...
    <?php if ($this->config->show_sort_product){?>
           <span class="box_products_sorting"><?php print 'Сортировать по'.": ".$this->sorting?><img src="<?php print $this->path_image_sorting_dir?>" alt="orderby" onclick="submitListProductFilterSortDirection()" /></span>
...
<input type="hidden" name="limitstart" value="0" />
        ...
        <div  class="choose_style show-style">
              <?php print $this->select_style?>
        </div>
